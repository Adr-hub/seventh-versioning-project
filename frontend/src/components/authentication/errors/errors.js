...
const Errors = (props) => {
    if (props.error === 'wrong-email') {
        ...
        return (<p className="empty-form" ref={props.paragraphClass}>The username field is empty !</p>);
    }

    else if (props.error === 'empty-pass') {
        return (<p className="empty-form" ref={props.paragraphClass}>The password field is empty !</p>);
    }
